...
namespace Report.API.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddApplication(this IServiceCollection services)
        {
            ...
            services.AddTransient<IInputFactory, InputFactory>();
            services.AddScoped<IOutputService, OutputService>();
            services.AddTransient<IOutputFactory, OutputFactory>();
            services.AddScoped<IReportAuthenticationService, ReportAuthenticationService>();

            services.AddValidatorsFromAssemblyContaining<UserForCreationDtoValidator>();
            services.AddValidatorsFromAssemblyContaining<InputForCreationDtoValidation>();
            services.AddValidatorsFromAssemblyContaining<OutputForCreationDtoValidation>();
